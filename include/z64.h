...
typedef struct GraphicsContext {
    ...
    /* 0x008 */ char pad8[8]; /* maybe part of polyXluBuffer[3]? */
    /* 0x010 */ Gfx* overlayBuffer;
    /* 0x014 */ u32 unk_14;
    /* 0x018 */ char pad18[0x20]; /* maybe part of unk_14[9]? */
    /* 0x038 */ void* msgBuff[8];
    /* 0x058 */ OSMesgQueue* schedMsgQ;
    /* 0x05C */ OSMesgQueue queue;
    /* 0x074 */ char pad74[4];
    /* 0x078 */ OSScTask task;
    /* 0x0D0 */ char padD0[0xD0]; /* maybe part of task[3]? */
    /* 0x1A0 */ Gfx* workBuffer;
    /* 0x1A4 */ TwoHeadGfxArena work;
    /* 0x1B4 */ Gfx* debugBuffer;
    /* 0x1B8 */ TwoHeadGfxArena debug;
    /* 0x1C8 */ char pad1C8[0xAC]; /* maybe part of debug[0xB]? */
    ...
    /* 0x2DB */ u8 framebufferIdx;
    /* 0x2DC */ void (*callback)(struct GraphicsContext*, u32);
    /* 0x2E0 */ u32 callbackParam;
    /* 0x2E4 */ f32 xScale;
    /* 0x2E8 */ f32 yScale;
